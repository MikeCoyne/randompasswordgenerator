...
function writePassword() { //overall function
...
function Prompt1() { //collects the user's choice- length of characters
  let lengthChoice = (prompt("how many characters would you like in your password", "Choose a number between 8 and 128"));//validate the entry isn't a word
